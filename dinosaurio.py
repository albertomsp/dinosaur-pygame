...
#NOTA: Para hacer lo de los niveles creo que es mejor en vez de poner contadorMeteoritos > 15, sustituir el 
...
def main():
	...
	while 1:
		...
		#En el contadorJamon se puede poner algo para el nivel, por ejemplo contadorJamon == nivel * 50 o algo por el estilo
